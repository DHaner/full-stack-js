...
export default function NewPassword() {
  ...
  useEffect(() => {
    async function verifyToken() {
      try {
        await veterinarioService.nuevoPassword(token);
        setValidToken(true);
  ...
  return (
    <>
      ...
      {validToken ? (
        <>
          <p className="text-slate-300 mt-5">Asegúrate de elegir una contraseña segura que puedas recordar fácilmente</p>
          ...
          <div className='text-red-500 flex flex-col gap-2 items-center mt-5'>
